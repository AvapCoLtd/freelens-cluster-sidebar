...
# GitHub ミラーと公開リリース。
#
#   ci/github.sh mirror            master とタグを AvapCoLtd/freelens-cluster-sidebar へ push する
...
REPO="${GH_REPO:-AvapCoLtd/freelens-cluster-sidebar}"
...
release)
  ...
  body="freelens-cluster-sidebar ${tag#v} — FreeLens の Extensions 画面にドラッグ&ドロップしてインストール。詳細は README を参照。"
